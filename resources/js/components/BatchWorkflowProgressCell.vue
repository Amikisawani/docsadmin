<template>
  <div class="wf-progress-cell">
    <div v-if="!batch.currentWorkflowInstance" class="wf-empty">
...
const instance = computed(() => props.batch.currentWorkflowInstance);
...
const canRemind = computed(() => {
  ...
  const isAuthor = props.batch.created_by === props.currentUserId;
